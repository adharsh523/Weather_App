...
const API_KEY=`6d3daaae5dcb0417e9471cdcec7d8596`;
setInterval(() =>{
    const time = new Date();
    ...
    timeEl.innerHTML=(hoursIn12HrFormat < 10 ? '0'+hoursIn12HrFormat : hoursIn12HrFormat) + ':' + (minutes <10 ?'0'+minutes : minutes) +' '+`<span id="ap-pm">${ampm}</span>`;
